...
CREATE TABLE user(
    ...
    user_cancelcount INT DEFAULT 0,
    user_counthours INT DEFAULT 0,
...
(205422706, 'Jeremy William Vega Fuenzalida', '2001-04-06', 'Villa los Alamos, San Felipe', 958645204, 'jeremyvf16@gmail.com', 'JVemyS1$', FALSE, 0,0, 1),
(205422707, 'Camila Andrea González Fuentes', '1992-09-25', 'Av. Los Olivos #456, San Felipe', 958632145, 'camilagonzalez92@example.com', 'CamilaGF92@',FALSE, 0,0, 1),
(208745623, 'Juan Carlos Herrera Soto', '1985-05-12', 'Calle Los Sauces #789, San Felipe', 958632587, 'juanherrera85@example.com', 'JuanHSoto85#',FALSE, 0,0, 1),
(107896512, 'María José Sánchez Vergara', '1980-11-30', 'Av. Las Acacias #234, Viña del Mar', 974125836, 'mariajose@example.com', 'MJSanchez80@',FALSE, 0,0, 2),
(109864237, 'Pedro Pablo Gómez Rojas', '1998-03-17', 'Calle Los Laureles #567, Viña del Mar', 974589632, 'pedropablo@example.com', 'PPGRojas98@',FALSE, 0,0, 2),
(205216789, 'Patricia Andrea González Soto', '1991-02-28', 'Calle Los Arrayanes #987, San Felipe', 958632180, 'patriciags@example.com', 'PatriciaGS91@',FALSE, 0,0, 1),
(108964510, 'Martín Ignacio Pérez Torres', '1982-11-15', 'Av. Las Palmeras #654, San Felipe', 958632181, 'martinperez@example.com', 'MartinPTorres82@',FALSE, 0,0, 1),
(105672410, 'Laura Andrea Rojas Pérez', '1990-08-14', 'Av. Los Jazmines #789, San Felipe', 958632189, 'laurarojas90@example.com', 'LauraRPerez90@',FALSE, 0,0, 1),
(212345698, 'Sofía Alejandra Ramírez Pérez', '1987-07-10', 'Calle Los Cipreses #789, Viña del Mar', 974125845, 'sofiaramirez@example.com', 'SofiaRPerez87@',FALSE, 0,0, 2),
(209785412, 'Mateo Sebastián Silva López', '1995-04-02', 'Av. Los Abedules #456, Viña del Mar', 974589630, 'mateosilva@example.com', 'MateoSLopez95@',FALSE, 0,0, 2),
(112345690, 'Joaquín Andrés Rodríguez Vásquez', '1980-05-25', 'Av. Las Magnolias #654, Viña del Mar', 974125846, 'joaquinrodriguez@example.com', 'JRodriguez80@',FALSE, 0,0, 2),
(205216790, 'Catalina Paz Gómez Rojas', '1986-09-12', 'Calle Los Tulipanes #321, San Felipe', 958632182, 'catalinagomez@example.com', 'CatalinaGRojas86@',FALSE, 0,0, 1),
(105422708, 'Daniela Paz Valenzuela López', '1987-07-02', 'Calle El Mirador #321, San Felipe', 958632154, 'danielaval@example.com', 'DPValenzuela87#',FALSE, 0,0, 1),
(205672419, 'Valentina Paz Soto Rojas', '1985-03-19', 'Calle Los Girasoles #321, San Felipe', 958632190, 'valentinasoto@example.com', 'VPSoto85@',FALSE, 0,0, 1),
(209876234, 'Diego Alejandro Martínez Vargas', '1979-09-10', 'Av. Las Orquídeas #456, Viña del Mar', 974125839, 'diegomartinez@example.com', 'DAMartinez79@',FALSE, 0,0, 2),
(207896513, 'Fernando José Mendoza Silva', '1976-01-18', 'Av. Los Pinos #456, Viña del Mar', 974125837, 'fernando@example.com', 'FJMendoza76@',FALSE, 0,0, 2),
(105672420, 'Felipe Andrés Ramírez Pérez', '1993-10-05', 'Calle Los Lirios #123, San Felipe', 958632183, 'feliperamirez@example.com', 'FelipeRPerez93@',FALSE, 0,0, 1),
(108753621, 'Gabriel Antonio Morales Castillo', '1983-04-27', 'Calle Las Rosas #456, San Felipe', 958632187, 'gabrielmorales83@example.com', 'GabrielMC83@',FALSE, 0,0, 1),
